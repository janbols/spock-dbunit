...
/**
  * Specification showing that DbUnit uses the datasource that is specified in the DbUnit#datasourceProvider closure
  */
class DatasourceProviderSpecification extends Specification{
